module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Elaina'
      if (!('sk_author' in setting)) setting.sk_author = '@AbdulMasukSurga_'
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/06c4e93a3d3f388b2642d.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/CVf4jyqdMZt56sSn9rH4BQ'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: false,
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6285869074622'],
         lastReset: new Date * 1,
         msg: 'Halo +tag 🪸\nIni adalah Elaina yang baru, silahkan gunakan fitur yang ada dengan sewajarnya\njangan spam karena diberi jeda 2 detik dan masing" orang diberi limit 25\nribu:v',
         menuStyle: 2,
         cover: 'https://telegra.ph/file/06c4e93a3d3f388b2642d.jpg',
         link: 'https://chat.whatsapp.com/CVf4jyqdMZt56sSn9rH4BQ'
      }
   }
}