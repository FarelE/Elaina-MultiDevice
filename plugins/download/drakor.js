   ...
   async: async (m, {
      ...
      try {
         if (command == 'drakor') {
            ...
            client.sendListv2(m.chat, '', `Menampilkan hasil dari pencarian untuk : “${text}“, Pilih drama yang kamu ingin download. Batch artinya download sekaligus, jadi tidak perlu download satu per satu episode`, '', 'Klik disini ea!', rows, m)
